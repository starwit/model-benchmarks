...
numactl -N 0 -m 0-55,112-115 python benchmark.py -s 60t -b 1 -i ~/workspaces/datasets/carmel/ArchWestMainStreetEB/
numactl -N 0 -m 0-55,112-115 python benchmark.py -s 60t -b 2 -i ~/workspaces/datasets/carmel/ArchWestMainStreetEB/
numactl -N 0 -m 0-55,112-115 python benchmark.py -s 60t -b 4 -i ~/workspaces/datasets/carmel/ArchWestMainStreetEB/
numactl -N 0 -m 0-55,112-115 python benchmark.py -s 60t -b 8  -i ~/workspaces/datasets/carmel/ArchWestMainStreetEB/
numactl -N 0 -m 0-55,112-115 python benchmark.py -s 60t -b 16 -i ~/workspaces/datasets/carmel/ArchWestMainStreetEB/
numactl -N 0 -m 0-55,112-115 python benchmark.py -s 60t -b 32 -i ~/workspaces/datasets/carmel/ArchWestMainStreetEB/
numactl -N 0 -m 0-55,112-115 python benchmark.py -s 60t -b 64 -i ~/workspaces/datasets/carmel/ArchWestMainStreetEB/

numactl -N 0 -m 0-55,112-127 python benchmark.py -s 72t -b 1 -i ~/workspaces/datasets/carmel/ArchWestMainStreetEB/
numactl -N 0 -m 0-55,112-127 python benchmark.py -s 72t -b 2 -i ~/workspaces/datasets/carmel/ArchWestMainStreetEB/
numactl -N 0 -m 0-55,112-127 python benchmark.py -s 72t -b 4 -i ~/workspaces/datasets/carmel/ArchWestMainStreetEB/
numactl -N 0 -m 0-55,112-127 python benchmark.py -s 72t -b 8  -i ~/workspaces/datasets/carmel/ArchWestMainStreetEB/
numactl -N 0 -m 0-55,112-127 python benchmark.py -s 72t -b 16 -i ~/workspaces/datasets/carmel/ArchWestMainStreetEB/
numactl -N 0 -m 0-55,112-127 python benchmark.py -s 72t -b 32 -i ~/workspaces/datasets/carmel/ArchWestMainStreetEB/
numactl -N 0 -m 0-55,112-127 python benchmark.py -s 72t -b 64 -i ~/workspaces/datasets/carmel/ArchWestMainStreetEB/

numactl -N 0 -m 0-55,112-139 python benchmark.py -s 84t -b 1 -i ~/workspaces/datasets/carmel/ArchWestMainStreetEB/
numactl -N 0 -m 0-55,112-139 python benchmark.py -s 84t -b 2 -i ~/workspaces/datasets/carmel/ArchWestMainStreetEB/
numactl -N 0 -m 0-55,112-139 python benchmark.py -s 84t -b 4 -i ~/workspaces/datasets/carmel/ArchWestMainStreetEB/
numactl -N 0 -m 0-55,112-139 python benchmark.py -s 84t -b 8  -i ~/workspaces/datasets/carmel/ArchWestMainStreetEB/
numactl -N 0 -m 0-55,112-139 python benchmark.py -s 84t -b 16 -i ~/workspaces/datasets/carmel/ArchWestMainStreetEB/
numactl -N 0 -m 0-55,112-139 python benchmark.py -s 84t -b 32 -i ~/workspaces/datasets/carmel/ArchWestMainStreetEB/
numactl -N 0 -m 0-55,112-139 python benchmark.py -s 84t -b 64 -i ~/workspaces/datasets/carmel/ArchWestMainStreetEB/
